                        ...
                        <div className="about-content-part">
                            ...
                            <SlideUp>
                                <ul className="list-style-one two-column">
                                    ...
                                    <li><i><RiArrowRightUpLine size={18} /></i> ReactJS site Building</li>
                                    <li><i><RiArrowRightUpLine size={18} /></i> Next JS Web site  Developer</li>
                                    <li><i><RiArrowRightUpLine size={18} /></i> Web-Vital Optmization</li>
